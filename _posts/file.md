...
Now we have clear data in data lake. Next request is we have to go through this data Lake and remove/update all of these email addresses but keep everything else so now I have to worry about updates can you even do that in the data Lake okay 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM5NDE2MTM1MiwxNzUyMzE5NzMwLC0xMD
