...
## Solution
Delta Lake provide a good way to handle the schema changes. Delta lake on spark store the data on DataFrames and every data frame in Spark contains a schema 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzYzNDk5OTk5LC0xNjQzMjYxNjQzLC0xOT
