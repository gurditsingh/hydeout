...
**Lets understand state with Example**![window events](https://github.com/gurditsingh/blog/blob/gh-pages/_screenshots/join_stream.jpg?raw=true)
 ...
 - Batch 1 we have two events one from start event and one from end event. both events are stored in start state and end sthave same event id **R1** so join output comes as (R1,01:00,01:04) 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzQ1NTQ0MDMyLC0xOTQ0Njc3NDQwLDE2Nz
