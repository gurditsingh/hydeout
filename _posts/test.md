...
KTables are equivalent to DB tables(), and as in these, using a KTable means that you just care about the latest state of the row/entity, which means that any previous states can be safely thrown away.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4NjEwNDQ5NzUsLTE2MjA2NjczMjQsLT
