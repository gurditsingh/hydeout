...
-   In Second run we again insert 1 million records but it generates duplicates surrogates keys because second run doesn’t know about first run keys.
	...
	**Evaluation of monotonically_increasing_id()**
	 ...
	 - **Performance :** Job performance can hamper because zipwithindex will trigger another job and rdd to dataframe converstion can be quite expensive operation.
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjEzNjc0NzMxNiwxMjE4NDc2NTA5LC0xNz
