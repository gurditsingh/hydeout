...
In the below image we have highlighted cloud services which are segregated from first and last layer. First layer has no change, it just has input data and last layer  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg0Njk4MzI1Miw3MTUzMDI3NTIsMTg3ND
