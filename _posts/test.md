...
If we see in the above results of ls command we have bunch of output files in parquet(that we will discuss later) and one directory called _delt
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzA1NjA1MzIwLDE5OTEyMDUxNDcsLTExNT
