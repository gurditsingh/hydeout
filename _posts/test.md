...
Suppose you have to create a functionality in which user can preview the input data or intermediate data. In traditional ETL tools like ABI initio, Inf

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTMzMTMwNDg0OSwxNDE3NzI1MjMxLC01Mz
