...
If we see in the above results of ls command we have bunch of output files in parquet (that we will discuss later) and one directory called **_delta_log**. As we know Delta lake provides number of features like ACID transactions, scalable metadata handling, time travel and others. The Delta lake have achived these functionalites with the help of _delta_log as known as Delta transaction log.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMzc0NDkxNjksMTk5MTIwNTE0NywtMT
...
MjcyODcxNiw1NTA1NDM5MDYsMzExMTg2NjQ4LC03ODIwNjQyNT
AsLTIwODg3NDY2MTIsLTMzMjQ1NTM2M119
-->