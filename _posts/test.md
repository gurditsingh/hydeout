...
![window events](https://github.com/gurditsingh/blog/blob/gh-pages/_screenshots/streaming_late_data.jpg?raw=true)
 ...
 - Batch 2 have three events from 04:10 to 04:20 and if you see in the above diagram Batch 2 table for watermark calculations then 04:00 is the threshold value. the event 04:04 is late event but it's acceptable because watermark value is 04:00 (any value grater than this considered as valid).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjE0MjA5ODc2OCwxMDE4MTAwMjEzLDE1Nj
